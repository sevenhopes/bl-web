...
<div id="news-n-events" class="wrap">
	...
	<?php else : ?>
	<header class="bl-page-header">
		<h2 class="bl-page-title"><?php _e( 'Posts', 'blmobilefirst' ); ?></h2>
	</header>
	<?php endif; ?>
		...
		<main id="main" class="site-main" role="main">
			...
			if ( have_posts() ) :
				...
				the_posts_pagination(
					array(
						'prev_text'          => blmobilefirst_get_svg( array( 'icon' => 'arrow-left' ) ) . '<span class="screen-reader-text">' . __( 'Previous page', 'blmobilefirst' ) . '</span>',
						'next_text'          => '<span class="screen-reader-text">' . __( 'Next page', 'blmobilefirst' ) . '</span>' . blmobilefirst_get_svg( array( 'icon' => 'arrow-right' ) ),
						'before_page_number' => '<span class="meta-nav screen-reader-text">' . __( '', 'blmobilefirst' ) . ' </span>',
					)
				);
