...
$teachers = array(
	...
	new Teacher( "t-peter", 	"팀장 이상인 (Peter)",	"이 상 인 'Peter'",			array("Stage Program"), "팀장 / 교육연구부" ),
	...
	new Teacher( "t-aileen",	"강사 심은애 (Aileen)", "심 은 애 'Aileen'" ),
	new Teacher( "t-yoon",		"강사 강혜윤 (Yoon)", "강 혜 윤 'Yoon'" ),
