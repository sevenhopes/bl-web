...
<div id="foundation-story" class="">

	<div class="bl-page-header">
		<div class="bl-page-title">Foundation Story</div>
		<h1 class="bl-heading">설립 배경</h1>
	</div>
	...
	<div class="bl-block">
		<div class="bl-block-header">
			<h2 class="bl-block-title">브릿지라잇 연혁</h2>
			<div class="bl-block-header-media">
				<img class="size-full wp-image-569" src="/wp-content/uploads/2019/04/origin-of-bridge-light-logo.jpg" srcset="<?php echo wp_get_attachment_image_srcset( 569 ) ?>" sizes="100vw" alt="미스터오어가 스케치한 브릿지라잇 로고 (2001)" />
			</div>
		</div>

		<div class="bl-wrap">
			<?php if ( wp_is_mobile() ) : ?>
			<img loading="lazy" class="size-large wp-image-2284 aligncenter" src="http://bridgelightels.com/wp-content/uploads/2020/08/ig-history-302x800.png" alt="브릿지라잇 연혁" width="302" height="800" />
			<?php else : ?>
			<img loading="lazy" class="size-large wp-image-2284 aligncenter" src="http://bridgelightels.com/wp-content/uploads/2020/08/ig-history.png" alt="브릿지라잇 연혁" width="600" height="1460" />
			<?php endif ?>
		</div>
