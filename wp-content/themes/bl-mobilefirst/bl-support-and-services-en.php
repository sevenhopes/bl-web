...
<div id="support-and-services" class="">
	...
	<div class="bl-block">
		...
		<div class="bl-wrap">
			<p class="bl-p">브릿지라잇은 원생들의 노력을 응원하고 격려하기 위해 장학재단을 운영하고 있습니다. 원생들은 이 달의 우수학생, 어휘 시험, 팝송 컨테스트, 할로윈 코스츔 컨테스트 등 정규교과 중의 학업 성취 뿐 아니라 여러 행사에서의 활약을 통해서 장학금을 적립할 수 있습니다.<!--  학교에서, 사회에서, 브릿지라잇 장학생들은 맹활약하고 있습니다. --></p>
		</div>
	</div>
	...
	<div class="bl-block">
		...
		<div class="bl-wrap">
			...
			<h3>Christmas</h3>
			<p class="bl-p">영어권 국가에서 크리스마스는 단순한 공휴일 그 이상이며, 우리나라의 명절과 같은 하나의 문화입니다. 그래서 크리스마스가 어떤 날인지 알아 보고, 사람들이 크리스마스에 무엇을 하는지 경험해 보는 것은 단순한 놀이가 아닌 영어 학습의 연속입니다.<!--  크리스마스 이브에는 다함께 파티를 즐기며, 겨울에 어울리는 선물이 각 원생에게 전달 됩니다. 파티를 여는 것은 일 년 동안 학업에 열중한 아이들에게 잠시 휴식과 함께 격려하는 의미도 있습니다. --></p>
		</div>
	</div>
