 ...
 */
function blmobilefirst_custom_colors_css() {
	 ...
	 */
	$saturation         = absint( apply_filters( 'blmobilefirst_custom_colors_saturation', 50 ) );
...
.colors-custom.page:not(.blmobilefirst-front-page) .entry-title,
...
.colors-custom .blmobilefirst-panel .recent-posts .entry-header .edit-link {
...
.colors-custom.blmobilefirst-front-page .panel-content .recent-posts article,
...
.colors-custom.blmobilefirst-front-page article:not(.has-post-thumbnail):not(:first-child),
...
@media screen and (min-width: 48em) {
	 ...
	 */
	return apply_filters( 'blmobilefirst_custom_colors_css', $css, $hue, $saturation );
}
