...
<div id="support-and-services" class="">
	...
	<div class="bl-block">
		<div class="bl-block-header">
			<h2 class="bl-block-title">장학 재단</h2>
		</div>

		<div class="bl-wrap">
			<p class="bl-p">브릿지라잇은 원생들의 노력을 응원하고 격려하기 위해 장학재단을 운영하고 있습니다. 원생들은 이 달의 우수학생, 어휘 시험 등 정규교과 중의 학업 성취 뿐 아니라, 팝송 컨테스트, 할로윈 코스츔 컨테스트 등 여러 행사에서의 활약을 통해서 장학금을 적립할 수 있습니다.<!--  학교에서, 사회에서, 브릿지라잇 장학생들은 맹활약하고 있습니다. --></p>
		</div>
	</div>

	<div class="bl-block">
		<div class="bl-block-header">
			<h2 class="bl-block-title">드림과 나눔</h2>
		</div>
	...
	<div class="bl-block">
		<div class="bl-block-header">
			<h2 class="bl-block-title">통학버스</h2>
		</div>
