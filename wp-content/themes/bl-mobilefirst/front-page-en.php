 ...
 *
 * 브라우저 언어가 영어일 때, 첫페이지로 정적인 페이지(static page)를 선택한 경우 보여짐
	...
	<main id="main" class="site-main" role="main">
		...
		<div id="bl-front-page-ko" class="bl-wp-page">
			...
			<div class="bl-content-top">
				...
				<div class="creed">
					<img src="/wp-content/themes/bl-mobilefirst/assets/images/widescreen/creed_en.jpg?ver=1.0" width="320" height="270" alt="Bridge Light Creed" />
				</div>
			</div>

			<div id="bl-quick-menu">
				<div class="tele"><a href="tel:033-243-5757"><i class="bl-sp icon-call" title="Dial Now"></i><span>Dial Now</span></a></div>
				<div class="appt"><a href="/admission/appt-and-visit/"><i class="bl-sp icon-map" title="Location"></i><span>Location</span></a></div>
				<div class="curr"><a href="/curriculum/course-overview/"><i class="bl-sp icon-book" title="Curriculum"></i><span>Curriculum</span></a></div>
				<div class="camp"><a href="/curriculum/english-camp/"><i class="bl-sp icon-devel" title="English Camps"></i><span>English Camps</span></a></div>
				<div class="admt"><a href="/curriculum/admission-process/"><i class="bl-sp icon-mortar" title="Admissions"></i><span>Admisisons</span></a></div>
				<div class="faq"><a href="/admission/faq/"><i class="bl-sp icon-faq" title="Frequently Asked Questions"></i><span>FAQ</span></a></div>
			</div>
			...
			<div id="bl-news" class="bl-block">
				...
				if ( ! $query->have_posts() ) :
					echo "<p>Oops, there is no news. However, we are studying hard here! :)</p>";
				else :
					// 최근 글을 하나 이상 보여줌
					$query->the_post();
					while ( true ) :
			...
			<div id="bl-event" class="bl-block">
				...
				?>
					...
					<div class="bl-event-comment">* Red events mean closing</div>
				<?php
					endif;
				endforeach;
			...
			<div id="bl-curriculum" class="bl-block">
				...
				<a href="/curriculum/course-overview/">
					<div class="bl-link-wrapper">
						<div class="bl-block-header-media">
							<img class="size-medium wp-image-2023" src="/wp-content/uploads/2020/02/Graphic-Roadmap-2019-09v2.jpg" srcset="<?php echo wp_get_attachment_image_srcset( 2023 ) ?>" sizes="100vw" alt="The Curriculum Roadmap of Bridge Light" />
						</div>
						<div class="bl-wrap">
			...
			<div id="bl-go-with-us" class="bl-block">
				...
				<a href="/admission/admission-process/">
					<div class="bl-link-wrapper">
						<div class="bl-block-header-media">
							<img class="size-medium wp-image-802" src="/wp-content/uploads/2019/04/summer-musical-camp-2018.jpg" srcset="<?php echo wp_get_attachment_image_srcset( 802 ) ?>" sizes="100vw" alt="English Musical Camp during the Summer Vacation" />
						</div>
						<div class="bl-wrap">
