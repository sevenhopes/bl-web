...
<div id="foundation-story" class="">
	...
	<div class="bl-block">
		...
		<img class="size-full wp-image-1886" src="http://www.bridgelightels.com/m/wp-content/uploads/2019/09/mr-mrs-orr.jpg" srcset="<?php echo wp_get_attachment_image_srcset( 1886 ) ?>" sizes="100vw" alt="데이빗 오어 원장과 김보미 부원장" />
	...
	<div class="bl-block">
		<div class="bl-block-header">
			...
			<div class="bl-block-header-media">
				<img class="size-full wp-image-569" src="http://www.bridgelightels.com/m/wp-content/uploads/2019/04/origin-of-bridge-light-logo.jpg" srcset="<?php echo wp_get_attachment_image_srcset( 569 ) ?>" sizes="100vw" alt="미스터오어가 스케치한 브릿지라잇 로고 (2001)" />
			</div>
		</div>
